...
Identify the build by commit rather than by the version on screen, because a development build
reports whatever tag came last rather than the code it holds. [Scope](../rules/scope.md) covers
where a finding goes next, and the [README](../README.md) is the way back.

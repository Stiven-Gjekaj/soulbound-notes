...
One note per boss: its attacks, its phases, and the shape of the fight from the first turn to
the last.

## Belongs here

- The attacks a boss has, and the order the player meets them in
- Phases, and what changes at each one
- What the fight teaches, and what it punishes
- The fight's personality, meaning how it behaves rather than how it looks
